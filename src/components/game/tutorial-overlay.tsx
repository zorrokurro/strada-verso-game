...
const STEPS = [
  ...
  {
    title: "下方輸入你的行動",
    body: "用自然語言描述你想做的事，例如「我檢查實驗體的狀況」或「我感覺空氣中的溫度變化」。Enter 送出，Shift+Enter 換行。第一次輸入的是你的名字，AI 會據此生成角色。",
    highlight: "input",
    icon: "▸",
  },
  {
    title: "準備好了嗎？",
    body: "頂部的「筆記 / 回顧 / 教學 / 角色」可隨時叫出。能力的覺醒是漸進的——你不會直接看到「使用了能力」，而是透過身體感覺來感知。祝你好運。",
    highlight: null,
    icon: "★",
  },
];
